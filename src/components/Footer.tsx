...
const Footer = ({ bgColor = "bg-neutral-50" }) => {
  return (
    <section id="footer" className="">
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap gap-10 px-[15%] py-20 justify-between">
        ...
        <div className="flex flex-col items-start gap-5 ">
          ...
          <form className="h-14 w-full flex">
            <input
              type="text"
              placeholder="Your Email"
              className="w-52 md:w-auto pl-3 h-full bg-stone-50 rounded-tl-lg rounded-bl-lg border border-neutral-200 "
            />
      ...
      <div className="px-[15%] py-8 bg-neutral-50">
        <p className="text-center md:text-left text-neutral-500 text-base font-bold font-['Montserrat']  tracking-[0.2px]">
